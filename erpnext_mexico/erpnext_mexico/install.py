...
CUSTOM_FIELDS = {
    ...
    "Delivery Note": [
        ...
        dict(fieldname="mx_origen_rfc", label="RFC Remitente", fieldtype="Data", insert_after="mx_origen_section"),
        dict(fieldname="mx_origen_estado", label="Estado Origen", fieldtype="Data", insert_after="mx_origen_rfc"),
        dict(fieldname="mx_origen_cp", label="CP Origen", fieldtype="Data", insert_after="mx_origen_estado"),
        dict(fieldname="mx_origen_calle", label="Calle Origen", fieldtype="Data", insert_after="mx_origen_cp"),
        dict(fieldname="mx_column_break_origen", fieldtype="Column Break", insert_after="mx_origen_calle"),
        # Destination
        dict(fieldname="mx_destino_rfc", label="RFC Destinatario", fieldtype="Data", insert_after="mx_column_break_origen"),
        dict(fieldname="mx_destino_estado", label="Estado Destino", fieldtype="Data", insert_after="mx_destino_rfc"),
        dict(fieldname="mx_destino_cp", label="CP Destino", fieldtype="Data", insert_after="mx_destino_estado"),
        dict(fieldname="mx_destino_calle", label="Calle Destino", fieldtype="Data", insert_after="mx_destino_cp"),
        ...
        dict(fieldname="mx_placa_vm", label="Placa", fieldtype="Data", insert_after="mx_config_vehicular"),
        dict(fieldname="mx_anio_modelo", label="Año Modelo", fieldtype="Int", insert_after="mx_placa_vm"),
        dict(fieldname="mx_column_break_vehiculo", fieldtype="Column Break", insert_after="mx_anio_modelo"),
        dict(fieldname="mx_aseguradora", label="Aseguradora", fieldtype="Data", insert_after="mx_column_break_vehiculo"),
        dict(fieldname="mx_poliza_seguro", label="Póliza de Seguro", fieldtype="Data", insert_after="mx_aseguradora"),
        dict(fieldname="mx_operador_nombre", label="Nombre Operador", fieldtype="Data", insert_after="mx_poliza_seguro"),
        dict(fieldname="mx_operador_rfc", label="RFC Operador", fieldtype="Data", insert_after="mx_operador_nombre"),
        dict(fieldname="mx_operador_licencia", label="No. Licencia", fieldtype="Data", insert_after="mx_operador_rfc"),
        # CFDI status
        dict(fieldname="mx_cp_cfdi_section", label="CFDI Carta Porte", fieldtype="Section Break", insert_after="mx_operador_licencia", collapsible=1),
        dict(fieldname="mx_cp_uuid", label="UUID Carta Porte", fieldtype="Data", read_only=1, insert_after="mx_cp_cfdi_section"),
        dict(fieldname="mx_cp_status", label="Estado Carta Porte", fieldtype="Select", options="\nPendiente\nTimbrado\nError\nNo aplica", read_only=1, insert_after="mx_cp_uuid"),
        dict(fieldname="mx_cp_xml", label="XML Carta Porte", fieldtype="Attach", read_only=1, insert_after="mx_cp_status"),
    ],
    # ── Salary Slip ──
    "Salary Slip": [
...
def create_payroll_custom_fields():
    ...
    payroll_fields = {
        ...
        "Salary Slip": [
            ...
            dict(
                fieldname="mx_nomina_fecha_timbrado",
                label="Fecha de Timbrado",
                fieldtype="Datetime",
                read_only=1,
            ...
            dict(
                ...
                fieldtype="Select",
                options="\nO\nE",
                insert_after="mx_nomina_fecha_timbrado",
                default="O",
                description="O=Ordinaria (quincena/semana regular), E=Extraordinaria (aguinaldo, liquidación).",
            ),
            dict(
                fieldname="mx_subsidio_al_empleo",
                label="Subsidio al Empleo",
                fieldtype="Currency",
                insert_after="mx_tipo_nomina",
                description="Importe del subsidio al empleo aplicable (OtroPago tipo 002 en CFDI).",
            ),
        ],
